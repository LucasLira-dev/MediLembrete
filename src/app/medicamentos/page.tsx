...
//         <section className="flex flex-col mt-4 md:justify-center md:items-center xl:flex-row xl:ml-4">
...
//               <article className="bg-[#1f2937] flex flex-col md:justify-center md:items-center w-full md:w-[400px] rounded-md p-4 mb-4">
