...
export default function Home() {
  ...
  const buscarMedicamentos = useCallback(async () => {
    try {
      const response = await API_MideLembrete.medicamentos.getAllByUser(
        Number(userId)
      );
  ...
  return (
    <>
      ...
      <main className="flex flex-col min-h-screen gap-2">
        ...
        <section className="flex flex-col mt-4 sm:items-center sm:justify-center xl:flex-row xl:items-start xl:justify-start xl:ml-4">
          <article className="p-4 flex-1">
            <h2 className=" text-[22px] font-medium p-4">Seus Medicamentos</h2>

            <div className="flex sm:justify-center sm:items-center md:items-center md:justify-start flex-col sm:flex-row sm:flex-wrap gap-2 min-h-[200px] xl:max-h-[450px] 2xl:max-h-[500px] overflow-y-auto">
            ...
            <article className="p-4 flex flex-2  md:justify-center sm:w-[80vw] xl:max-w-[400px]">
              <article className="bg-[#1f2937] flex flex-col md:justify-center md:items-center w-full rounded-md p-4 mb-4">
                ...
                <Form
                  action={async (formData: FormData) => {
                    ...
                    mostrarALert(
                      ...
                      "O medicamento foi adicionado à sua lista."
                    );
                  }}
                  className="flex flex-col w-full gap-2 px-4 bg-[#04102E] rounded-md p-2  mb-4"
                >
                ...
                <div className="bg-[#020817] rounded-md p-2 w-full mb-4 flex justify-center items-center gap-2 cursor-pointer hover:bg-[#1D4ED8] hover:text-white">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="bg-[#223B67] text-white mb-2 p-2 rounded-lg w-full cursor-pointer hover:bg-[#1D4ED8] hover:text-white"
                    >
                      Salvar Medicamento
                    </button>
                  </div>
